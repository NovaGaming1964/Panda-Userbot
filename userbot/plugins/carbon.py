...
@borg.on(lightning_cmd(pattern="carbon"))
...
@borg.on(lightning_cmd(pattern="kar1"))
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
...
@borg.on(lightning_cmd(pattern="kar2"))
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    cat = await edit_or_reply(event, "📛📛📛📛📛")
...
@borg.on(lightning_cmd(pattern="kar3"))
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    cat = await edit_or_reply(event, "🎛🎛🎛🎛🎛")
...
@borg.on(lightning_cmd(pattern="kar4"))
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    cat = await edit_or_reply(event, "🌚🌚🌚🌚🌚")
...
@borg.on(lightning_cmd(pattern="kargb"))
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
