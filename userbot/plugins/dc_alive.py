...
# 🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "𝒫𝒜𝒩𝒟𝒜-𝒰𝒮𝐸𝑅𝐵𝒪𝒯"
...
""" =======================CONSTANTS====================== """
pm_caption = "** 𝒫𝒜𝒩𝒟𝒜-𝒰𝒮𝐸𝑅𝐵𝒪𝒯 𝙸𝚂 🅾🅽🅻🅸🅽🅴**\n\n"

pm_caption += "✘ About My System ✘\n\n"
pm_caption += "➾ **`ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀꜱɪᴏɴ`** ☞ 1.17.5\n"
pm_caption += "➾ **`ꜱᴜᴘᴘᴏʀᴛ ᴄʜᴀɴɴᴇʟ`** ☞ [ᴊᴏɪɴ](https://t.me/a)\n"
pm_caption += "➾ **`ʟɪᴄᴇɴꜱᴇ`**  ☞ [𝒫𝒜𝒩𝒟𝒜-𝒰𝒮𝐸𝑅𝐵𝒪𝒯](https://github.com/a)\n"
pm_caption += "➾ **`ᴄᴏᴘʏʀɪɢʜᴛ ʙʏ`** ☞ [𝒫𝒜𝒩𝒟𝒜-𝒰𝒮𝐸𝑅𝐵𝒪𝒯](https://github.com/NovaGaming1964/Panda-Userbot)\n\n"
