    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("Help Me ❓", "https://t.me/a")],
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy ᴘᴀɴᴅᴀ-ᴜꜱᴇʀʙᴏᴛ In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
                [
                    Button.url(
                        "Deploy Tutorial 📺",
                ...
                [Button.url("Need Help ❓", "https://t.me/a")],
                [Button.url("Web💫", "https://a")],
            ],
        )
