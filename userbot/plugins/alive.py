...
if ALIVE_PIC is None:
    PM_iMG = "https://telegra.ph/file/901b4b66d5e959edfc207.mp4"
else:
    PM_iMG = ALIVE_PIC
...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/901b4b66d5e959edfc207.mp4"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/8b5c468b8552549218d8c.jpg"
else:
    CAT_IMG = CAT_IMGE
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        pm_caption = "**ᴘᴀɴᴅᴀ-ᴜꜱᴇʀʙᴏᴛ 𝙸𝚂 🅾︎🅽🅻🅸🅽🅴**\n"
        pm_caption += f"**𝕄𝕪 𝔹𝕠𝕤𝕤**            : {DEFAULTUSER}\n"
        pm_caption += "𝚃𝙴𝙻𝙴𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽        : 1.17.5\n"
        pm_caption += "𝙿𝚈𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽          : 3.9.0\n"
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/a)\n"
        )
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/a)\n"
        )
        pm_caption += "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://a)\n"
        pm_caption += "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ ᴘᴀɴᴅᴀ-ᴜꜱᴇʀʙᴏᴛ ](https://t.me/a)\n"
        pm_caption += "[┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/a)"
        ...
        return
    req = requests.get("https://telegra.ph/file/d2e9f3128bf34a660a693.mp4")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/a)\n"
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/a)\n"
            "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://a)\n"
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ вℓα¢к ℓιgнтηιηg ](https://t.me/a)\n"
            "[ ┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/a)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption = "__**🔥🔥𝓟𝓐𝓝𝓓𝓐-𝓤𝓢𝓔𝓡𝓑𝓞𝓣 ɨs օռʟɨռɛ🔥🔥**__\n\n"
...
pm_caption += f"😈𝓟𝓐𝓝𝓓𝓐-𝓤𝓢𝓔𝓡𝓑𝓞𝓣😈       : __**{hellversion}**__\n"

pm_caption += f"⚜️Sudo⚜️            : `{sudou}`\n"

pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/a)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/a)\n\n"

pm_caption += "    [✨REPO✨](https://github.com/NovaGaming1964/Panda-Userbot) 🔹 [📜License📜](https://github.com/NovaGaming1964/Panda-Userbot)"
...
async def amireallyalive(calive):
    ...
    if PM_IMG:
        ...
        pm_caption += f"**{EMOJI} Panda-Userbot Version :** `{catversion}`\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} Panda-Userbot Version :** `{catversion}`\n"
...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "Panda-Userbot"
