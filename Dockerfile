...
#Import Gudz
RUN wget https://raw.githubusercontent.com/NovaGaming1964/Panda-Userbot/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/NovaGaming1964/Panda-Userbot/master/requirements.txt
#Start Fumkin
